...
function EntityStatsHud({ started, setStarted, entities }: Props) {
  return (
    <div className="w-[200px] border-r border-blue-500 px-2 py-4">
        ...
        <div key={index} className="border-b border-blue-300 py-2  px-2">
          ...
          <div className="flex gap-3">
            <div className="flex gap-1">
              ...
              {entity.hitPoints <= 0 && <Image alt="death" src={deadSVG.src} width={16} height={16} />}
            </div>
            <div className="flex gap-1">
      ...
      <Button text={started ? 'STOP' : 'START'} handleClick={() => setStarted(!started)} />
    </div>
  );
}
